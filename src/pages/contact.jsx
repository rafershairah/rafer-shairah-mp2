          ...
          <div className="row text-center align-items-center">
            <div className="col-lg-6 col-md-12 p-3">
              <div className="map card m-auto embed-responsive embed-responsive-16by9">
                <iframe
                  src=" //www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d61911.25972590417!2d122.89941671885988!3d14.109393291633689!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3398ae57889668c7%3A0xb348444a6a1fc08a!2sDaet%2C%20Camarines%20Norte!5e0!3m2!1sen!2sph!4v1695936772168!5m2!1sen!2sph"
                  loading="lazy"
            ...
            <div className="col-lg-6 col-md-12">
              <div className="card p-5">
                ...
                <p className="mb-2">
                  <b>Address:</b> Daet, Camarines Norte
                </p>
                <p className="mb-2">
                  <b>Phone:</b>{" "}
                  <a className="footer-tel" href="tel:+639123456789">
                    Call us at +639123456789
                  </a>
                </p>
                <p className="mb-4">
